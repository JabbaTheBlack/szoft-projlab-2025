...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Created 5 Tektons - all are neighbors, 4 connected in line");
        ...
        Hyphae firstHyphae = redMycologist.getHyphaes().get(0);    // Get the first hyphae
        redMycologist.growHyphaeToTekton(firstHyphae, t2);         // Grow to t2
        Hyphae secondHyphae = redMycologist.getHyphaes().get(1);   // Get the second hyphae
        redMycologist.growHyphaeToTekton(secondHyphae, t3);        // Grow to t3
        Hyphae thirdHyphae = redMycologist.getHyphaes().get(2);   // Get the third hyphae
